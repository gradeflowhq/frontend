 ...
 */
export type CodeTestQuestionRuleOutputMode = typeof CodeTestQuestionRuleOutputMode[keyof typeof CodeTestQuestionRuleOutputMode];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CodeTestQuestionRuleOutputMode = {
  ALL: 'ALL',
  ANY: 'ANY',
  PARTIAL: 'PARTIAL',
} as const;
