 ...
 */
export type KeywordsQuestionRuleInputMode = typeof KeywordsQuestionRuleInputMode[keyof typeof KeywordsQuestionRuleInputMode];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const KeywordsQuestionRuleInputMode = {
  ALL: 'ALL',
  ANY: 'ANY',
  PARTIAL: 'PARTIAL',
} as const;
