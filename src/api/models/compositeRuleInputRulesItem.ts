...
export type CompositeRuleInputRulesItem = BonusRuleInput | CompositeRuleInput | CustomCodeRuleInput | CodeTestRuleInput | SimilarityRuleInput | TextMatchRuleInput | KeywordsRuleInput | RegexRuleInput | LengthRuleInput | MultiValuedRuleInput | MultipleChoiceRuleInput | NumberEqualRuleInput | NumericRangeRuleInput;
