...
export type CompositeRuleInputRulesItem = BonusRuleInput | CompositeRuleInput | ProgrammableRuleInput | ProgrammingRuleInput | SimilarityRuleInput | TextMatchRuleInput | KeywordsRuleInput | RegexRuleInput | LengthRuleInput | MultiValuedRuleInput | MultipleChoiceRuleInput | NumberEqualRuleInput | NumericRangeRuleInput;
