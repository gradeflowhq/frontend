...
export type CompositeQuestionRuleInputRulesItem = BonusRule | CompositeRuleInput | ProgrammableRule | ProgrammingRule | TextMatchRule | KeywordsRule | RegexRule | LengthRule | ManualRule | MultiValuedRuleInput | MultipleChoiceRule | NumberEqualRule | NumericRangeRule;
