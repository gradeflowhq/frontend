 ...
 */
export type CodeTestQuestionRuleInputMode = typeof CodeTestQuestionRuleInputMode[keyof typeof CodeTestQuestionRuleInputMode];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CodeTestQuestionRuleInputMode = {
  ALL: 'ALL',
  ANY: 'ANY',
  PARTIAL: 'PARTIAL',
} as const;
