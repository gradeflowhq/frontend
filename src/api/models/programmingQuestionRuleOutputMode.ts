 ...
 */
export type ProgrammingQuestionRuleOutputMode = typeof ProgrammingQuestionRuleOutputMode[keyof typeof ProgrammingQuestionRuleOutputMode];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ProgrammingQuestionRuleOutputMode = {
  ALL: 'ALL',
  ANY: 'ANY',
  PARTIAL: 'PARTIAL',
} as const;
