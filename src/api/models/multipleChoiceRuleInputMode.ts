 ...
 */
export type MultipleChoiceRuleInputMode = typeof MultipleChoiceRuleInputMode[keyof typeof MultipleChoiceRuleInputMode];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const MultipleChoiceRuleInputMode = {
  ALL: 'ALL',
  ANY: 'ANY',
  PARTIAL: 'PARTIAL',
} as const;
