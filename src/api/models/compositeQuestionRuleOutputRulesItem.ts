...
export type CompositeQuestionRuleOutputRulesItem = BonusRule | CompositeRuleOutput | ProgrammableRule | ProgrammingRule | TextMatchRule | KeywordsRule | RegexRule | LengthRule | ManualRule | MultiValuedRuleOutput | MultipleChoiceRule | NumberEqualRule | NumericRangeRule;
