 ...
 */
export type AssumptionInputRule = BonusRule | CompositeRuleInput | ProgrammableRule | ProgrammingRule | TextMatchRule | KeywordsRule | RegexRule | LengthRule | ManualRule | MultiValuedRuleInput | MultipleChoiceRule | NumberEqualRule | NumericRangeRule;
