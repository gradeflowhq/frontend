...
export type RubricOutputRulesItem = AssumptionSetQuestionRuleOutput | BonusQuestionRuleOutput | CompositeQuestionRuleOutput | CustomCodeQuestionRuleOutput | CodeTestQuestionRuleOutput | SimilarityQuestionRuleOutput | TextMatchQuestionRuleOutput | KeywordsQuestionRuleOutput | RegexQuestionRuleOutput | LengthQuestionRuleOutput | MultiValuedQuestionRuleOutput | MultipleChoiceQuestionRuleOutput | NumberEqualQuestionRuleOutput | NumericRangeQuestionRuleOutput | AssumptionSetMultiQuestionRuleOutput | ConditionalMultiQuestionRuleOutput | CustomCodeMultiQuestionRuleOutput;
