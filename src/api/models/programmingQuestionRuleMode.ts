 ...
 */
export type ProgrammingQuestionRuleMode = typeof ProgrammingQuestionRuleMode[keyof typeof ProgrammingQuestionRuleMode];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ProgrammingQuestionRuleMode = {
  ALL: 'ALL',
  ANY: 'ANY',
  PARTIAL: 'PARTIAL',
} as const;
