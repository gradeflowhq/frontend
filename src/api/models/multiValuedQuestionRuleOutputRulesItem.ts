...
export type MultiValuedQuestionRuleOutputRulesItem = BonusRuleOutput | CompositeRuleOutput | CustomCodeRuleOutput | CodeTestRuleOutput | SimilarityRuleOutput | TextMatchRuleOutput | KeywordsRuleOutput | RegexRuleOutput | LengthRuleOutput | MultiValuedRuleOutput | MultipleChoiceRuleOutput | NumberEqualRuleOutput | NumericRangeRuleOutput;
