 ...
 */
export type ProgrammingQuestionRuleInputMode = typeof ProgrammingQuestionRuleInputMode[keyof typeof ProgrammingQuestionRuleInputMode];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ProgrammingQuestionRuleInputMode = {
  ALL: 'ALL',
  ANY: 'ANY',
  PARTIAL: 'PARTIAL',
} as const;
