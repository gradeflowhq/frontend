...
/**
 * Responsive master-detail shell shared by SingleTargetRulesSection and
...
const MasterDetailLayout: React.FC<MasterDetailLayoutProps> = ({
  ...
  return (
    <>
      ...
      >
        <Text mb="md">
          You have an unsaved rule edit. Going back will discard it.
        </Text>
        <Group justify="flex-end" gap="sm">
          <Button variant="subtle" onClick={() => setPendingBack(false)}>
            Stay
          </Button>
          <Button
            color="red"
