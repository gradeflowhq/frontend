...
const AUXILIARY_TERMS = ['pts', 'points', 'marks', 'score', 'rubric', 'explain', 'comment'];
...
const SHORT_ID_REGEX = /^[A-Za-z0-9\-_]{6,12}$/;

// Choice signals (case-insensitive via toUpperCase)
const CHOICE_LETTERS = new Set(['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H']);
